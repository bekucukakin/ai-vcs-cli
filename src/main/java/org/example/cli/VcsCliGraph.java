...
public class VcsCliGraph {
    ...
    public VcsCliGraph(InitService initService, StagingService stagingService,
                       CommitService commitService, LogService logService,StatusService statusService) {
        ...
        while (true) {
            ...
            switch (parts[0]) {
                ...
                case "init":
                    ...
                    break;
                case "add":
                    stagingService.handleAdd(parts.length > 1 ? parts[1] : ".");
                    break;
                case "commit":
                    loadStaging();
                    commitService.commit(parts.length > 1 ? parts[1] : "No message", staging);
                    saveStaging();
                    break;
                case "log":
                    logService.showLog();
                ...
                case "status":
                    ...
                    statusService.showStatus(showDiff, targetFile);
                    break;
